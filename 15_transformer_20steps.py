...
# # Positional embeddings (temporales)
# def temporal_positional_embedding(n_frames, d_model, name="temb"):
#     """
#     Embedding aprendible para posiciones temporales [0..n_frames-1],
#     sumado a las features antes de la atención.
#     """
#     pos_ids = tf.keras.layers.Input(shape=(n_frames,), dtype='int32', name=f"{name}_ids")
#     emb = Embedding(input_dim=n_frames, output_dim=d_model, name=name)(pos_ids)
#     return pos_ids, emb
